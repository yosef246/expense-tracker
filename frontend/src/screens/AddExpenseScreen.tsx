...
export default function AddExpenseScreen() {
  ...
  const handleSave = () => {
    ...
    setSaving(true);
    addExpense(num, description.trim(), date);
...
const s: Record<string,React.CSSProperties> = {
  ...
  inp:   { width:'100%', padding:'14px 16px', borderRadius:14, border:'2px solid #e2e8f0', fontSize:16, background:'white', color:'#1e293b', textAlign:'right', direction:'rtl' as const, outline:'none', boxSizing:'border-box' as const, transition:'border-color 0.2s' },

  saveBtn: { width:'100%', padding:16, marginTop:24, background:'linear-gradient(135deg,#6366f1,#8b5cf6)', color:'white', border:'none', borderRadius:14, fontSize:17, fontWeight:'700', cursor:'pointer', boxShadow:'0 4px 20px rgba(99,102,241,0.4)', letterSpacing:0.3 },
};
